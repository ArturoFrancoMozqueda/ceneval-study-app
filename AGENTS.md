...
- Un paquete nuevo solo se importa si usa el contrato 1.2 y pasa
  ...
  evidencia concreta y verificable. C01–C28 ya usan 1.2 y pasan el gate local;
  C29–C40 permanecen en 1.1, son legibles, pero no son importables ni
  publicables.
...
- **El contrato publicable es 1.2.** C01–C28 son los pilotos migrados:
  ...
  150, 152, 151, 150, 152, 150, 150 y 149 artefactos, respectivamente, enlazan
  evidencia oficial o localizadores verificables de la transcripción. C29–C40 siguen en 1.1 y solo son legibles:
