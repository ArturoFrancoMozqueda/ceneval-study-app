...
- El repositorio conserva 54 paquetes académicos vigentes (C01–C54), una
...
- Un paquete nuevo solo se importa si usa el contrato 1.2 y pasa
  ...
  evidencia concreta y verificable. C01–C54 ya usan 1.2 y pasan el gate local.
...
| `content/packages/` | Los 54 paquetes académicos vigentes C01–C54 en JSON. |
...
- **El contrato publicable es 1.2.** C01–C54 son los paquetes trazables:
  ...
  150, 152, 151, 150, 152, 150, 150, 149, 151, 151, 151, 151, 151, 151, 151, 151, 154, 155, 156, 155, 150, 153, 148, 154, 148, 150, 148, 150, 150, 151, 153, 150, 154 y 149 artefactos, respectivamente,
...
- **Las transcripciones tienen una primera copia privada verificada.** El 21 de
  ...
  su igualdad con SHA-256. Los 54 paquetes vigentes usan nombres portables
