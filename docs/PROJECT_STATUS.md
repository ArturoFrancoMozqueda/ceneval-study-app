...
El repositorio conserva C01–C34 como pilotos trazables en contrato 1.2,
C35–C40 legibles en contrato 1.1 y una versión retirada en el archivo
editorial. C01–C34 pasan el gate local, pero no se han importado, revisado ni
publicado; C35–C40 todavía no son publicables bajo el gate trazable 1.2. La
...
Los 40 paquetes C01–C40 tienen código, orden y fuentes portables. C01–C34 ya
usan 1.2: sus 139, 130, 133, 133, 137, 137, 138, 138, 140, 141, 139, 142, 144
y 138, 137, 142, 142, 142, 143, 148, 150, 152, 151, 150, 152, 150, 150, 149, 151, 151, 151, 151, 151 y 151 artefactos quedaron enlazados a
12, 17, 12, 12, 14, 18, 10, 15, 13, 18, 21, 16, 12, 12, 12, 12, 15, 10, 18,
15, 18, 14, 16, 19, 19, 21, 15, 20, 15, 16, 15, 13, 13 y 15 evidencias verificables, respectivamente, y pasan el gate
local sin importar contenido. C35–C40 permanecen en 1.1 y no pasan el nuevo gate. El importador acepta
...
el proyecto remoto; C01–C34 y C41 no se han importado.
...
flashcards, diez reactivos y fuentes. C01–C34 pasan el gate local 1.2, pero
aún requieren revisión y publicación autorizadas; C35–C40 no deben describirse
...
4. Aplicar la persistencia 1.2 ya aprobada localmente en un proyecto de ensayo;
   C01–C34 ya cuentan con evidencia real verificable para ese ensayo.

### Prioridad 1 — Cerrar el pipeline con C01–C34

1. Mantener los localizadores reales y paquetes C01–C34 en contrato 1.2.
...
### Prioridad 2 — Migrar C35–C40 y después completar C41–C58
...
| 5 | Aprobar C01–C34 | Recorrido trazable completo sin evidencia inventada |
