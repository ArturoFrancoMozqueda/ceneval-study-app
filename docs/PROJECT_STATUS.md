...
El repositorio conserva C01–C22 como pilotos trazables en contrato 1.2,
C23–C40 legibles en contrato 1.1 y una versión retirada en el archivo
editorial. C01–C22 pasan el gate local, pero no se han importado, revisado ni
publicado; C23–C40 todavía no son publicables bajo el gate trazable 1.2. La
...
Los 40 paquetes C01–C40 tienen código, orden y fuentes portables. C01–C22 ya
usan 1.2: sus 139, 130, 133, 133, 137, 137, 138, 138, 140, 141, 139, 142, 144
y 138, 137, 142, 142, 142, 143, 148, 150 y 152 artefactos quedaron enlazados a
12, 17, 12, 12, 14, 18, 10, 15, 13, 18, 21, 16, 12, 12, 12, 12, 15, 10, 18,
15, 18 y 14 evidencias verificables, respectivamente, y pasan el gate local sin
importar contenido. C23–C40 permanecen en 1.1 y no pasan el nuevo gate. El importador acepta
...
el proyecto remoto; C01–C22 y C41 no se han importado.
...
flashcards, diez reactivos y fuentes. C01–C22 pasan el gate local 1.2, pero
aún requieren revisión y publicación autorizadas; C23–C40 no deben describirse
...
4. Aplicar la persistencia 1.2 ya aprobada localmente en un proyecto de ensayo;
   C01–C22 ya cuentan con evidencia real verificable para ese ensayo.

### Prioridad 1 — Cerrar el pipeline con C01–C22

1. Mantener los localizadores reales y paquetes C01–C22 en contrato 1.2.
...
### Prioridad 2 — Migrar C23–C40 y después completar C41–C58
...
| 5 | Aprobar C01–C22 | Recorrido trazable completo sin evidencia inventada |
...
4. continuar la migración trazable desde C23 antes de C41.
